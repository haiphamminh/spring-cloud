package com.spring.cloud.service.rating.controller;

import com.spring.cloud.service.rating.model.Rating;
...
public class RatingController {
    ...
    public List<Rating> findRatingsByBookId(@RequestParam Long bookId) {
        return bookId == null || bookId.equals(0L) ? Collections.EMPTY_LIST : ratingList.stream()
